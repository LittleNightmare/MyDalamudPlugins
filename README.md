# Dalamud Plugins
Contains the repository JSON file for my Dalamud Plugins for third party plugin support. Fork from [LeonBlade](https://github.com/LeonBlade/DalamudPlugins)
...
* Copy and Paste in the following URL into one of the blank inputs under the "Custom Plugin Repositories" section: https://raw.githubusercontent.com/LittleNightmare/MyDalamudPlugins/main/repo.json or https://raw.fastgit.org/LittleNightmare/MyDalamudPlugins/main/repo.json
...
All of my plugins are tagged with my username "LittleNightmare", so you can enter that in the search field to see all of the plugins I've created.
...
* [UsedName](https://github.com/LittleNightmare/UsedName)
